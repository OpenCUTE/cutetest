input_file = "/home/yuanbin/merge-test/chipyard/sims/verilator/output/chipyard.harness.TestHarness.CUTEShuttle512D512V512M256S1CoreConfig/ibert_4_res.out"  # 要筛选的文件
...
# with open(f"../conv_value_mnk_49_128_128_k1_s1_oh7.h", "r") as f:
    # 读取所有内容
    content = f.read()
    data = content.split("resadd1_buf = ")[1].split(";")[0]
