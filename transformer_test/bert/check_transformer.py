input_file = "/home/yuanbin/merge-test/chipyard/sims/verilator/output/chipyard.harness.TestHarness.CUTEShuttle512D512V512M256S1CoreConfig/transformer_cute.out"  # 要筛选的文件
...
with open(filter_file, "r") as infile:
    ...
    tensor_block_baseaddr = 0x80395500
    line_index = 0
    iter_n = 0
    iter_m = 0
    # 遍历文件每一行
