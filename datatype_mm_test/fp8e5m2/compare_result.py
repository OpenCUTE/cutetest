...
test_name = f"cute_Matmul_fp8_mnk_{shape}_{shape}_{shape}_{bias_type_name[bias_type]}"
...
with open(f"./matmul_value_fp8_mnk_{shape}_{shape}_{shape}_{bias_type_name[bias_type]}.h", "r") as f:
    content = f.read()
