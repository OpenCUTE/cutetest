...
test_name = f"cute_Matmul_mxfp4_mnk_{shape}_{shape}_{shape}_{bias_type_name[bias_type]}"
...
with open(f"./matmul_value_mxfp4_mnk_{shape}_{shape}_{shape}_{bias_type_name[bias_type]}.h", "r") as f:
    content = f.read()
