...
for i in range(16, 64):
    exe_path = "./get_matrix_value"    # Linux/macOS示例

    # 要传递给程序的输入
    input_text = f"""1024 1024 {(i+1) * 256}
1
1
"""
    print(input_text)
    ...
    os.rename("matmul_value.h", f"matmul_value_mnk_1024_1024_{(i+1) * 256}_zeroinit_transpose.h")