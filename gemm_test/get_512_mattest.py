...
for i in range(17, 65):
    with open(f"matmul_value_mnk_512_512_{i * 256}_zeroinit_transpose.h", "w") as f:
        content = f"""#define APPLICATION_M 512
#define APPLICATION_N 512
#define APPLICATION_K {i*256}
#define BIAS_TYPE 1
//1:zero bias,2:repeat row bias,3:full bias
#define CONV_STRIDE 1
#define KERNEL_SIZE 1
#define KERNEL_STRIDE 0
#define STRIDE_A {256 * i}
#define STRIDE_B {256 * i}
...
static char a[512][{256 * i}] __attribute__((aligned(256)));
static char b[512][{256 * i}] __attribute__((aligned(256)));
