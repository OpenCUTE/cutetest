...
def get_all_test_cycle():
    ...
    with open("resnet50_conv_task.txt", "r") as f:
        ...
        for line in lines:
            ...
            num = num[0]
            print("conv_"+num)
            logpath = "/home/yuanbin/merge-test/chipyard/sims/verilator/output/chipyard.harness.TestHarness.CUTEM2564TCUTEShuttle512D512V512M256S1CoreConfig/vec_ops_conv_2.log"
