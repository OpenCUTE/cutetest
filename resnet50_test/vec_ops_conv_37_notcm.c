...
char faketcm[2*2048*2048] __attribute__((aligned(512)));
// 512位对齐的数组acc_t result[64][64]
void * CUTE_result[2] = {(void *) (faketcm), (void *) (faketcm + 64 * 3072 * 4)};//double buffer use shuttle tcm
